...
from shared.db import update_active_alert_duration, upsert_active_alert_duration, set_is_delayed, end_active_alert
    ...
    for entity in feed_response.entity:
        ...
        if alert.transit_realtime_mercury_alert.alert_type == "Delays":
            ...
            if not alert.active_period:
                ...
                # Delay is over, update alert record and make line not delated
